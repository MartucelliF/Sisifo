            ...
            if (isset($_SESSION['usuario'])) {
                ...
                if (mysqli_num_rows($iniciosesionConsulta) == 0) { //si no hay un usuario ya registrado con ese nombre_usuario y correo
                    ...
                    <div class="display">
                        ...
                        <?php
                            // PHP: Obtener la fecha actual del servidor
                            $fecha_actual = date('Y-m-d');
                            // Determinar el turno inicial según la hora actual
                        ...
                        <script>
                            // Función para actualizar dinámicamente la hora
                            ...
                            $hora_actual = date('H:i:s', strtotime('-4 hours', strtotime($hora_actual)));
                                ...
                                $turno_Maniana=false;
                                $turno_ManianaInicio = '22:07:00';
                                $turno_ManianaFin = '22:08:00';
                                ...
                                $turno_Tarde=false;
                                $turno_TardeInicio = '22:08:00';
                                $turno_TardeFin = '23:00:00';
                                if(($hora_actual>=$turno_TardeInicio)&&($hora_actual<=$turno_TardeFin)){
                                    $turno_Tarde=true;
                                    ?>
                                    <script>
                                        alert("CAMBIANDO DE TURNO: Tarde");
                                    </script>
                                    <h1> TURNO: Tarde</h1>
                                    <?php
                                }
