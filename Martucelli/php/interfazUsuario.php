...
<body>
    <?php
        ...
        //---------------------------------------------------------------------------------------------------
            ...
            // TODO PARA LOS MALDITOS AUDIOS

                // AUDIO AL INICIAR SESIÓN POR PRIMERA VEZ
                    if ($_POST['sesionIniciada'] == 'false') {
                        // Si es la primera vez, puedes establecer una variable en la sesión para evitar que se repita el sonido
                        $_SESSION['sesionIniciada'] = true;
                        // Redirigir a la interfaz de usuario con un parámetro en la URL
                        header("Location: paso=0?sesionIniciada=true");
                    } else {
