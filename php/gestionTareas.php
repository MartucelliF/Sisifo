...
<body>
    ...
    <div class="display">
        ...
        switch ($paso) {
            case 0:
                ...
                <form action="gestionTareas.php?paso=1" method="post">
                    <audio src="../audio/yunque1.mp3" autoplay></audio>
            ...
            case 1:
                ...
                <form action="gestionTareas.php?paso=2" method="post">
                    ...
                    <audio src="../audio/yunque2.mp3" autoplay></audio>
                    <fieldset class="datosTarea">
            ...
            case 2:
                ...
                <form action="gestionTareas.php?paso=3" method="post">
                    ...
                    <audio src="../audio/yunque3.mp3" autoplay></audio>
                    <fieldset class="datosTarea">
                        <label for="categoria">Categoría: <?php echo htmlspecialchars($categoria); ?></label>
                        <br><br>
            ...
            case 3:
                ...
                <form action="gestionTareas.php?paso=4" method="post">
                    <h1>Formulario de Gestión de Tareas: 2/4</h1>
                    <audio src="../audio/yunque4.mp3" autoplay></audio>
                    <fieldset class="datosTarea">
                        <label for="categoria">Categoría: <?php echo htmlspecialchars($categoria); ?></label>
                        <br><br>
                        <label for="subcategoria">Subcategoría: <?php echo htmlspecialchars($subcategoria); ?></label>
            ...
            case 4:
                ...
                <form action="gestionTareas.php?paso=5" method="post">
                    ...
                    <audio src="../audio/yunque5.mp3" autoplay></audio>
                    <fieldset class="datosTarea">
                    ...
                    <br>
                    <button type="submit" value="1" class="contboton" id="volver">
                        <a href="interfazUsuario.php"><img src="../img/botonSubir.png" alt="botonCerrarSesion" width="180px" height="30px"></a>
                    </button>                
                </form>
                <?php
            ...
            case 6:
                ...
                ?>
                <h1>Imprimir Rutina</h1>
                
                <audio id="audio" src="../audio/click.mp3" autoplay></audio>
                
                <button type="button" value="1" class="contboton" onclick="generarPDF()"><img src="../img/generarPDF.png" alt="botonCerrarSesion" width="250px" height="40px"></button>                
            ...
            case 7:
                ...
                if($estado == 'PENDIENTE'){
                    ...
                    if($EXP==9){
                        $AsignarEXPyNIVEL = "UPDATE usuarios SET EXP= 0, NIVEL=usuarios.NIVEL+1 WHERE nombre_usuario='$nombre_usuario';";
                        $AsignarEXPyNIVEL = mysqli_query($conexion,$AsignarEXPyNIVEL);
                    }else{
                        $AsignarEXPyNIVEL = "UPDATE usuarios SET EXP= usuarios.EXP+1 WHERE nombre_usuario='$nombre_usuario';";
                        $AsignarEXPyNIVEL = mysqli_query($conexion,$AsignarEXPyNIVEL);
                    }
        ...
        ?>
        <br><br><br><br><br>
            <button type="button" value="1" class="contboton" id="volver">
                <a href="interfazUsuario.php"><img src="../img/volver.png" alt="botonCerrarSesion" width="180px" height="30px"></a>
            </button> 
        </div>
    </div>
