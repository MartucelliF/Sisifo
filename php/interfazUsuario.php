...
//GUARDO LA IMAGEN
$consultaImg = "SELECT img FROM usuarios WHERE nombre_usuario='$nombre_usuario';";
$consultaImg = mysqli_query($conexion, $consultaImg);
$consultaImg = mysqli_fetch_row($consultaImg);
$IMAGEN_usuario = $consultaImg[0];
//----------------
    ...
    */
    ...
    if (!isset($_GET['paso']) || $_GET['paso'] == 0) {
        if (mysqli_num_rows($iniciosesionConsulta) == 0) { //si no hay un usuario ya registrado con ese nombre_usuario y correo
            ...
            ?>  
                <img src="<?php echo $IMAGEN_usuario; ?>" alt="Foto Perfil" width="50px" height="50px">
